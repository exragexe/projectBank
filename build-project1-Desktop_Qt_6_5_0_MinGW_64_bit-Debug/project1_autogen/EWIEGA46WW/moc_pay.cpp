...
static constexpr auto qt_meta_stringdata_CLASSpayENDCLASS = QtMocHelpers::stringData(
    "pay"
);
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSpayENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSpayENDCLASS_t qt_meta_stringdata_CLASSpayENDCLASS = {
    {
        QT_MOC_LITERAL(0, 3)   // "pay"
    },
    "pay"
};
